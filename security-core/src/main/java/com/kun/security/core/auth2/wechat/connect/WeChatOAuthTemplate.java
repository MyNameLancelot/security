 ...
 * 发出请求的类
 */
public class WeChatOAuthTemplate extends OAuth2Template {
    ...
    private static Logger log = LoggerFactory.getLogger(WeChatOAuthTemplate.class);

    public WeChatOAuthTemplate(String clientId, String clientSecret, String authorizeUrl, String accessTokenUrl) {
